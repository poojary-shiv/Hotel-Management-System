...
$total_amt=$_SESSION['total_session'];
?>
<!DOCTYPE html>
<html>
<head>
  <title>Hoteldeck | Payment</title>
  <meta charset="utf-8">
...
<body>
  <h2 style="text-align:center;color:#585858; font-weight:bolder; padding-top:15px; padding-bottom:10px;">Step 3 - Payment</h2>
  <div class="container" style="width:600px;">
    <div class="jumbotron">
  <form class="needs-validation" onsubmit="return validate();" action="step3_script.php" method="POST">
